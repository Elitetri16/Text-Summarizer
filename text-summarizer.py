...
from tkinter import scrolledtext     # Import scrolledtext module from tkinter
from sumy.parsers.plaintext import PlaintextParser  # Import PlaintextParser from sumy.parsers.plaintext
from sumy.nlp.tokenizers import Tokenizer           # Import Tokenizer from sumy.nlp.tokenizers
from sumy.summarizers.lex_rank import LexRankSummarizer  # Import LexRankSummarizer from sumy.summarizers.lex_rank
...
def summarize_text():
    ...
    # Summarize the text
    summarized_sentences = summarizer(parser.document, 5)  # Summarize the text into 5 sentences
